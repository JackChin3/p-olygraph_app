...
const ThumbnailVideoDisplay = ({
  ...
  return (
    <div className="my-3 flex h-[240px] w-full flex-col items-center justify-center rounded">
      ...
      <button
        onClick={handleNavigate}
        className="h-20 w-40 rounded-md bg-white px-6 py-2 text-black transition-colors hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
      >
        View Analysis
      </button>
    </div>
